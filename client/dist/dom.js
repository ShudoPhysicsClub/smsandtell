export function styleInputBase(el) {
    el.style.width = '100%';
...
export function createRow(labelText, input) {
...
export function createInput(id, placeholder = '', value = '') {
...
export function createSection(titleText) {
